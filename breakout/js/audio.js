...
const Sound = {
  ...
  paddle() { this.beep(440, 0.05, 'square', 0.05); },
  wall() { this.beep(300, 0.035, 'square', 0.03); },
  brick(hp) { this.beep(520 + hp * 90, 0.05, 'square', 0.045); },
  brickBreak() { this.noise(0.12, 0.08); },
  laser() { this.beep(980, 0.04, 'square', 0.03); },
  ...
  clear() { [523, 659, 784, 1047].forEach((f, i) => this.beep(f, 0.14, 'square', 0.06, i * 0.11)); },
